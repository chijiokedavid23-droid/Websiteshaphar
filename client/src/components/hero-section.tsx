      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <a 
                href="https://sg-uco.com/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center justify-center bg-white/10 backdrop-blur-md border-2 border-white/40 text-white hover:bg-white hover:text-navy font-semibold text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-10 py-3 sm:py-4 rounded-xl transition-all duration-300 group"
              >
